...
** Implementation
This should take place in the unitTest() methods, there is a TODO there...
...
* Janitoring
*** replace in IntConstDiv all the instances of small tables by Table::newUniqueInstance
*** replace inPortMap and outPortMap by the modern interface newInstance()
		See FPAddSinglePath for examples
*** build a SNAP package https://docs.snapcraft.io/build-snaps/   or a Docker instance or something 
*** Add a proper Kintex7 target
