...
#define LOW_PREC 0
	...
	// 
	vector<mpz_class> FixSinCos::buildSinCosTable(int wIn, int lsbOut, int g, int argRedCase){
	...
	FixSinCos::FixSinCos(OperatorPtr parentOp, Target * target, int w_):Operator(parentOp,target), w(w_){
