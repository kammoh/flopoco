...
public:
     ...
     */
	DSPBlock(Operator *parentOp, Target* target, int wX, int wY, bool isPipelined=true, int wZ=0, bool usePostAdder=false, bool usePreAdder=false, bool preAdderSubtracts=false);
