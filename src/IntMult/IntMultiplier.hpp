...
namespace flopoco {
	...
	public:
         ...
         **/
        IntMultiplier(Operator *parentOp, Target* target, int wX, int wY, int wOut=0, bool signedIO = false, float dspOccupationThreshold=0.0, unsigned int maxDSP=0, bool superTiles=false, bool use2xk=false, bool useirregular=false, unsigned int beamRange = 0);
