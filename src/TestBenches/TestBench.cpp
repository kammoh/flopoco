...
namespace flopoco{
		...
		Operator(target), op_(op), n_(n), fromFile_(fromFile)
	{
		...
		//disabled during the transition to the new pipeline framework
		//	this is no longer valid, as the following functions make use of information
		//	that is generated by the scheduler, which has not been called at this point
		/*
