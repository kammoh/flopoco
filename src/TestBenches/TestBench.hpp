...
namespace flopoco{
	...
	public:
		...
		/**
		 * custom instance, for the unit under test
		 */
		string instanceSimple(Operator* op, string instanceName);
		...
		/** Method belonging to the Operator class overloaded by the TestBench class
		 * @param[in,out] s      the stream where the current architecture will be outputed to
		 * @param[in]     level  the indentation level
		 **/
		void outputFinalReport(ostream& s, int level);
